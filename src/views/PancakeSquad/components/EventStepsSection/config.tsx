  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active CrowFi Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      buttons: (
        <>
          <Button
            as="a"
            href="https://crowfi.app/swap?outputCurrency=0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82"
            target="_blank"
            width="100%"
          >
            {t('Buy CAKE')}
