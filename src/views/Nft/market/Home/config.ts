  ...
  return [
    {
      ...
      description: [
        ...
        t('You can instantly swap your WBNB for BNB with no trading fees on CrowFi.'),
      ],
    },
    {
      ...
      description: [
        t(
          'Soon! The current NFT Market is a basic version (phase 1), with early access to trading CrowFi NFTs only.',
        ),
    ...
    },
    {
      ...
      description: [
        ...
        t(
          'We are now accepting applications from NFT collection owners seeking to list their collections. Please apply here: https://docs.crowfi.app/contact-us/nft-market-applications',
        ),
      ],
    },
    {
      ...
      description: [
        t(
          '100% of all platform fees taken by CrowFi from sales are used to buy back and BURN CAKE tokens in our weekly CAKE burns.',
        ),
        t(
